          ...
          <TableBody>
            {boats.map((row) => (
              <TableRow key={row.name}>
                ...
                <TableCell align="right"><Switch onChange={(e: { target: { checked: any; }; }) => onChange(row, 'hire', e.target.checked)} checked={row.hire} /></TableCell>
                <TableCell align="right"><Switch onChange={(e: { target: { checked: any; }; }) => onChange(row, 'crewing', e.target.checked)} checked={row.crewing} /></TableCell>
